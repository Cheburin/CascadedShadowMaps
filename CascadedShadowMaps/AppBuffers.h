...
struct SceneState
{
	...
	DirectX::XMFLOAT4X4    light_camera1_projecion;
	DirectX::XMFLOAT4X4    light_camera1_view;
	DirectX::XMFLOAT4X4    light_camera1_inv_view;

	DirectX::XMFLOAT4      vDebugIndex;
	DirectX::XMFLOAT4      vDebugColor;
};

struct CascadeState
{
	DirectX::XMFLOAT4      CascadeScale[8];
	DirectX::XMFLOAT4      CascadeOffset[8];
	DirectX::XMFLOAT4      CascadeFrustumsEyeSpaceDepths[8];
};
